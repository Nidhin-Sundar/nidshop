...
const BestPicks = () => {
  ...
  return (
    <section className="hero">
      <div className="container mx-auto px-4 py-1 flex flex-col justify-center items-center text-center">
        <h1 className="text-4xl font-bold text-black ">Best Picks</h1>
      </div>
      <Slider {...settings}>
        {slides.map((slide, slideIndex) => (
          <div key={slideIndex} className="p-4">
            ...
            {slide.caption && (
              <h3 className="text-xl  text-center ">${slide.price}</h3>
            )}
          </div>
        ))}
      </Slider>
