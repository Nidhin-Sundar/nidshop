  ...
  return (
    <div>
      ...
      <div className="p-4 md:p-8  min-h-screen container mx-auto">
        ...
        {products.length === 0 ? (
          <>
            <p className="text-gray-600 mt-2 text-6xl">Your cart is empty.</p>
            <Link to="/">
              <button
                className="mt-44 w-56 text-white px-6 py-3 rounded-lg"
          ...
          <>
            <p className="text-gray-600 mt-2">
              There are{" "}
              <span style={{ color: "#3BB77E" }}>{products.length}</span>{" "}
